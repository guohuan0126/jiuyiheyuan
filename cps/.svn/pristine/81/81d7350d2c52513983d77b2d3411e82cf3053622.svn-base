				...
				<form class="form-inline" id="f1"  action="/netLoanEye/pushAgain" method="post">
						<table class="input-list" border="0" width="80%" cellspacing="10" cellpadding="5">
							<tr>
								<td>
									<input type="text" id="loanId" name="loanId"  value="${loanId}"  placeholder="项目编号" style="width:160px">
	             					<button type="button" id="pushLoan" onclick="pushNetLoan();"  >推送某个项目下所有的投资记录</button>
								</td>
								<td>
									<input type="text" id="loanId1" name="loanId1"  value="${loanId1}"  placeholder="项目编号" style="width:160px">
	             					<button type="button" id="pushLoan" onclick="pushNetLoanStatus();"  >推送更新的项目状态</button>
								</td>
								<td>
									<input type="text" name="userId"  id="userId" value="${userId}"  placeholder="投资人编号" style="width:160px">
	            	 				<button type="button" id="pushLoanByUserId" onclick="pushNetLoanByUserId();" >推送某用户下所有的投资记录</button>
								</td>
							...
							<tr>
					            ...
					            <td>
					            	 <button type="button" id="search" class="buttonStyle">查询</button>
					            </td>
							</tr>
						</table>
