...
<body>
	...
	<div id="content">
		...
		<div class="m-right">
			<div class="right-nav">
				<ul>
					<li>当前位置：爱有钱用户投资的记录</li>
				</ul>
				<br/>
				<form action="/aiyouqian/investInfo" method="get">
			...
			function exportInvestBill(){
				var url="/aiyouqian/exportUserInvestInfoAiyouqian";
