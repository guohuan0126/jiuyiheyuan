...
public class LogUtil {
	...
	private static final String serverUrl = "http://soa-log2.duanrong.com/log/error";
												//正式的话就更换soa-log2.duanrong.com
												//测试demosoa2-log.duanrong.net
	private static final String serverUrl2 = "http://soa-log2.duanrong.com/log/info";
