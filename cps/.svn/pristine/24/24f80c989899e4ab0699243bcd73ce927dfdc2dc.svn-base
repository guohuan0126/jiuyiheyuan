...
<body>
	...
	<div id="content">
		...
		<div class="m-right">
			<div class="right-nav">
				<ul>
					<li>当前位置：八金社用户投资的记录</li>
				</ul>
				<br/>
				<form action="/bjs/investByBjs" method="get">
			...
			function exportInvestBill(){
				var url="/bjs/exportUserInvestInfoBjs";
					...
					<div id="rule"></div>
						<div class="box-table">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								...
								<!-- 项目周期 -->
								<td>
								<c:if test="${investRecords.operationType=='月'}">${investRecords.month}月</c:if>	
