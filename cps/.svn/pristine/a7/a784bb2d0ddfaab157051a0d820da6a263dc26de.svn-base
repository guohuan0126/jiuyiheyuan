...
import com.duanrong.cps.business.user.UserConstants;
import com.duanrong.cps.business.user.dao.UserMoneyDao;
import com.duanrong.cps.business.user.model.User;
import com.duanrong.cps.business.user.model.UserMoney;
import com.duanrong.cps.business.user.service.UserMoneyService;
...
public class UserMoneyServiceImpl implements UserMoneyService {
	 ...
	 *            每页显示的记录数
	 */
	public PageInfo<UserMoney> findPaging(int pageNo, int pageSize, UserMoney um) {
		return userMoneyDao.pageLite(pageNo, pageSize, um);
	}
	...
	@Override
	public double getInvestingMoeny(String userId, String start, String end) {
