package com.duanrong.cps.business.invest.model;
...
public class Invest extends BaseModel {
	...
	private String loanDay;  //项目时间
	private String loanOperationType; //项目时间单位
	private String loanGiveMoneyTime; //起息日期
	...
	private String platformType; //第三方类型
	private String loanStatus; //标的状态
	private Date sendTime; //推送时间
	private String whetherNew; //是否为新用户
	private String thirdPlatformUserId; //第三方用户ID
	...
	public String getLoanOperationType() {
		return loanOperationType;
	}

	public void setLoanOperationType(String loanOperationType) {
		this.loanOperationType = loanOperationType;
	}

	public String getLoanGiveMoneyTime() {
		return loanGiveMoneyTime;
	}

	public void setLoanGiveMoneyTime(String loanGiveMoneyTime) {
		this.loanGiveMoneyTime = loanGiveMoneyTime;
	}
