 ...
 * 
 */
package com.duanrong.cps.business.netloaneye.service.impl;
...
import com.duanrong.cps.business.netloaneye.mapper.PushLoanMapper;
...
import com.duanrong.cps.util.p2pEyeUtil.P2PEyeHttpUtil;
import com.duanrong.cps.util.p2pEyeUtil.P2PEyeHttpUtilAgain;
...
public class NetLoanEyeServiceImpl implements NetLoanEyeService {
	 ...
	 * @return
	 */
	public PageInfo<Loan> getPushRecords(String pageNo, Loan loan){
	...
	public int pushNetLoan(String id,String userid){
		...
		System.out.println("#########天眼：推完成功，插入数据库");
		PushLoan p = getPushLoan(l,userid);
		int n=pushLoanMapper.insertSelective(p);
		System.out.println("#########天眼：推完成功，插入数据库n:"+n);
		return n;
	}
