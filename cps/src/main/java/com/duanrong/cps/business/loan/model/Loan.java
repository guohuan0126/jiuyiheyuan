...
public class Loan extends BaseModel {
	...
	private Date pushTime;//天眼项目推送时间
	private String pushTimeStart;
	private String pushTimeEnd;
	private Date updateTime;
	private String thirdType;  //第三方类型
	
	private Date nowTime; //比搜益最后更新时间
	
	private Double sumMoney; //已投金额
	
	private Date finishTime;//还款结束时间
	...
	public String toString() {
		return "Loan [id=" + id + ", name=" + name + ", borrowMoneyUser="
				...
				+ ", textItem=" + textItem + ", isdeal=" + isdeal
				+ ", startTime=" + startTime + ", endTime=" + endTime
				+ ", commitTime=" + commitTime + ", giveMoneyTime="
				+ giveMoneyTime + ", sponsorUser=" + sponsorUser
				+ ", contractName=" + contractName + ", picture=" + picture
				+ ", type=" + type + ", newbieEnjoy=" + newbieEnjoy
				...
				+ ", opendAuto=" + opendAuto + ", start=" + start + ", brand="
				+ brand + ", licensePlateNumber=" + licensePlateNumber
				+ ", maxcorpus=" + maxcorpus + ", maxinterest=" + maxinterest
				+ ", maxrepayday=" + maxrepayday + ", maxreapymoney="
				+ maxreapymoney + ", specialType=" + specialType
				+ ", pushTime=" + pushTime + ", pushTimeStart=" + pushTimeStart
				+ ", pushTimeEnd=" + pushTimeEnd + ", updateTime=" + updateTime
				+ ", thirdType=" + thirdType + ", nowTime=" + nowTime
				+ ", sumMoney=" + sumMoney + ", finishTime=" + finishTime
				+ ", end=" + end + ", statusStr=" + statusStr
				+ ", itemAddress=" + itemAddress + ", itemRate=" + itemRate
				+ ", customerManagerJobNumber=" + customerManagerJobNumber
				+ ", customerManagerName=" + customerManagerName
				+ ", borrowerName=" + borrowerName + ", yaCarAndGPS="
				+ yaCarAndGPS + ", remark=" + remark + "]";
	}
