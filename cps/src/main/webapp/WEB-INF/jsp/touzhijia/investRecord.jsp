...
<body>
	...
	<div id="content">
		...
		<div class="m-right">
			<div class="right-nav">
				<ul>
					<li>当前位置：投之家用户投资的记录</li>
				</ul>
				<br/>
				<form action="/touzhijia/investInfo" method="get">
			...
			function exportInvestBill(){
				var url="/touzhijia/exportUserInvestInfoTouZhiJia";
