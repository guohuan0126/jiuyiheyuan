...
<body>
	...
	<div id="content">
		...
		<div class="m-right">
			<div class="right-nav">
				<ul>
					<li>当前位置：爱有钱推送标的记录</li>
				</ul>
				<br/>
				<form id="searchForm"  action="${ctx}/aiyouqian/getPushLoanHistory"	method="get">
			...
			<script type="text/javascript">
				...
				<form  action="${ctx }/aiyouqian/getPushLoanHistory"	method="post" id="f1">
			</div>
					<div class="box">
					<div id="rule"></div>
						<div class="box-table">
