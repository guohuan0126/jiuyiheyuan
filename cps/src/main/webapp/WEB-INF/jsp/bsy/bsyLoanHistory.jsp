...
<body>
	...
	<div id="content">
		...
		<div class="m-right">
			<div class="right-nav">
				<ul>
					<li>当前位置：比搜益推送标的记录</li>
				</ul>
				<br/>
				<form id="searchForm"  action="${ctx}/bsy/getPushLoanHistory"	method="get">
				...
				<table class="input-list" border="0" width="80%" cellspacing="10" cellpadding="5">
					<tr>
						...
						<td width="45%">
							<span>项目提交时间：</span>
							<input id="loanTimeBegin" type="text" class="datepicker" name="timeBegin" value="${timeBegin}" placeholder="始时间"> --
							<input id="loanTimeEnd" type="text" class="datepicker"  name="timeEnd"  value="${timeEnd }" placeholder="结束时间">
						</td>
						<td width="17%">
							<span >项目状态：</span>
					...
					<tr>
						...
						<td>
							<span>项目推送时间：</span>
							<input id="pushTimeBegin" name="pushTimeBegin" value="${pushTimeBegin}" type="text" class="datepicker"  placeholder="始时间"> --
							<input id="pushtimeEnd"   name="pushtimeEnd"  value="${pushtimeEnd}" type="text" class="datepicker"    placeholder="结束时间">
						</td>
						<td>
							<span >项目类型：</span>
			...
			<script type="text/javascript">
				...
				<form  action="${ctx }/bsy/getPushLoanHistory"	method="post" id="f1">
			</div>
					<div class="box">
					<div id="rule"></div>
						<div class="box-table">
				 ...
				 <td><fmt:formatDate value="${loan.nowTime}" type="both"/></td>
								</tr>
...
<script type="text/javascript" src="/js/bsy/bsyloanhistory.js"></script>
</body>
</html>
