...
<body>
	...
	<div id="content">
		...
		<div class="m-right">
			<div class="right-nav">
				<ul>
					<li>当前位置：风车理财用户投资的记录</li>
				</ul>
				<br/>
				<form action="/fengchelicaiManager/investInfo" method="get">
						...
						<td>
							<select id="userType" name="userType">
								<option value="">--全部用户类型--</option>
	                  			...
	                  			<option value="3">风车理财平台投资</option>
							</select>	
						</td>
						<td >
			...
			function exportInvestBill(){
				var url="/fengchelicaiManager/exportUserInvestInfoFengche";
