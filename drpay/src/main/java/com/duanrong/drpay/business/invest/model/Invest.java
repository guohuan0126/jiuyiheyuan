package com.duanrong.drpay.business.invest.model;
...
public class Invest {
	...
	public String toString() {
		return "Invest [id=" + id + ", user=" + user + ", investUserID="
				+ investUserID + ", loan=" + loan + ", loanId=" + loanId
				+ ", time=" + time + ", isAutoInvest=" + isAutoInvest
				+ ", status=" + status + ", rate=" + rate + ", ratePercent="
				+ ratePercent + ", type=" + type + ", money=" + money
				+ ", paidMoney=" + paidMoney + ", paidInterest=" + paidInterest
				+ ", interest=" + interest + ", minInvestMoney="
				+ ", loanName=" + loanName + ", redpacketId="
				+ redpacketId + ", userSource=" + userSource + ", conditions="
				+ Arrays.toString(conditions) + ", investAllowanceInterest="
				+ investAllowanceInterest + ", managementExpense="
				+ managementExpense + "]";
	}
