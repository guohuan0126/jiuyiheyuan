...
import com.duanrong.dataAnalysis.util.HashCrypt;
...
public class UserServiceImpl implements UserService {
	...
	public String login(String username, String password) {
		...
		if(u == null){
			...
			{	
				...
				{
					return "1";//user has not permission;
				}
			}
	...
	public List<TemplateUser> getUserTemplate(String year, String month) {
		// TODO Auto-generated method stub
		return userDao.getUserTemplate(year,month);
	}
	...
	public int getUserCountByMobileNumber(String mobileNumber) {
		// TODO Auto-generated method stub
		return userDao.getUserCountByMobileNumber(mobileNumber);
	}
