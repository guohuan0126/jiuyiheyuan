...
<body>
	...
	$(function() {
	    ...
	    $("#today").click(function(){
	        ...
	        var categories = ['充值金额','提现金额'];
	       // name = '用户数据'
	    	$.ajax({
	    	    type:"post",
	    		url:"/CashData/showTCashData",
	    		data:{"id":"today"},
	    		dataType:"json",
	    		success:function(json){
	    			console.log(json);
	    			cat[0]=json.tpayMoney;
	    			cat[1]=json.tdrawMoney;
		   ...
		   success:function(json){
			   ...
			   for (var key in json) {
				   arr.push(key);
		            ...
		            console.log(key);
		            arrData.push(json[key][0].money);
		            arrData1.push(json[key][1].money);
		            data1[0]={name: "充值金额",data: arrData};
		            data1[1]={name: "提现金额",data: arrData1};
		        }  
