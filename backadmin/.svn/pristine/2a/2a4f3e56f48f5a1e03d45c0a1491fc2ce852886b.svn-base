...
public class DemandtreasureGuOutDetailServiceImpl implements DemandtreasureGuOutDetailService {
	...
	public List<DemandtreasureGuOutDetail> read(DemandtreasureGuOutDetail detail) {
		return demandtreasureGuOutDetailDao.find(detail);
	}

	@Override
	public PageInfo<DemandtreasureGuOutDetail> readPageInfo(int pageNo, int pageSize,DemandtreasureGuOutDetail d) {
