				...
				<form id="form" name="form" method="post" class="form-horizontal">
					<div class="panel panel-default">
						<div class="panel-heading">
							...
							<h4 class="panel-title">修改手机APP启动图</h4>
						</div>
						...
						<div class="form-group">
								...
								<div class="col-sm-3">
									<input type="text" name="id" id="id"  width="10px"
										class="form-control" value="${app.id}" readonly="true"  />
								</div>								
							</div>		
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input type="text" name="picPosition" id="picPosition" value="${app.picUrl}" width="10px" readonly="readonly" class="form-control"/>
										<div id="preview" class="bs-example bs-example-images" style="padding-top: 10px;" >

										   <img alt="${app.picName}" src="${app.picUrl}" class="img-thumbnail" style="width: 100px;height: 100px;" />
							...
							<div class="form-group">
					        	...
					        	<select name="picStatus" id="picStatus" class="form-control"  style="width:150px">					            	
					            	<option value="0" <c:if test="${app.status == '0' }">selected="selected"</c:if> >未使用</option>
					            	<option value="1" <c:if test="${app.status == '1' }">selected="selected"</c:if> >使用</option>
					            </select>
					            </div>
				            </div>			   
							<div class="form-group">
