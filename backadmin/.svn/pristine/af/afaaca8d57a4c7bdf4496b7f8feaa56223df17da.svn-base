	...
	<section>
		...
		<div class="mainpanel">
			...
			<div class="pageheader">
				<h2>
					<i class="fa fa-pencil"></i>修改银行卡信息
				</h2>				
			</div>
				...
				<form id="form" method="post" class="form-horizontal">
					<div class="panel panel-default">
						<div class="panel-heading">
							...
							<h5 class="panel-title">修改银行卡信息</h5>
						</div>
						<div class="panel-body">
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input type="text" name="mobileNumber" value="${mobileNumber}" onchange="checkMobileNumber()" id="mobileNumber"  width="10px"
										class="form-control"/>	
									<input type="hidden" id="id" value="${bankCardInfo.id}">
									<input type="hidden" id="loanerId" value="${loanerId}">
							...
							<div class="form-group">
								<label class="col-sm-3 control-label">银行卡 <font style="color: red">*</font></label>
								<div class="col-sm-3">
									<input type="text" name="bankCard" value="${base:decrypt(bankCardInfo.bankcard)}"  id="bankCard"  width="10px"
										class="form-control"/>	
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<select name="CaedType" id="cardSelect" class="form-control" style="width:50%;">
										...
										<option value="postCard">护照</option>
									</select>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input type="text" name="idCard" value="${base:decrypt(bankCardInfo.certno)}"  id="idCard"  width="10px"
										class="form-control"/>									
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input type="text" name="branchName" value="${bankCardInfo.branchname}"  id="branchName"  width="10px"
										class="form-control"/>									
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input type="text" name="bankMobile" value="${base:decrypt(bankCardInfo.bankMobile)}"   id="bankMobile"  width="10px"
										class="form-control"/>									
								</div>
							</div>
								<div class="form-group">
								...
								<div class="col-sm-3">
									<input type="text" name="remark" value="${bankCardInfo.remark}"  id="remark"  width="10px"
										class="form-control"/>									
								</div>
							</div>
								<div class="form-group">
		...
		$("#bankCode").val('${bankCardInfo.bankNum}');
		$("#cardSelect").val('${bankCardInfo.certtp}');
		$("#paymentChannel").val('${bankCardInfo.paymentChannel}');
			</script>
		<!-- 城市三级联动 -->
		...
		<script type="text/javascript">
			...
			$.ajax({
					type : 'POST',
					dataType:'text',
					url : "/agricultural/updateBankCardInfo",						
					data: {
						"id":id,
						"loanerId":loanerId,
						"mobileNumber":mobileNumber,
        ...
        var checkBankCard = function(content) {  
            ...
            if (regex.test(content)&&content.length<=20) {  
                return true;  
            }  
            return false;  
			}
		...
		<script type="text/javascript">
							$("#provinceId").val('${bankCardInfo.bankProvince}');
							var id = $("#provinceId").find("option[value='${bankCardInfo.bankProvince}']").attr("prID");
 			             getCity(id,"${bankCardInfo.bankCity}");
