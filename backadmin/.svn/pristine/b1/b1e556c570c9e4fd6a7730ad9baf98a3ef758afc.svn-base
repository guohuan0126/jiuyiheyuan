...
public class Loan extends BaseModel {
	...
	//是否可投，0不可投，1可投
	private Integer whetherInvested;
	
	
	/**
	 * @return the whetherInvested
	 */
	public Integer getWhetherInvested() {
		return whetherInvested;
	}

	/**
	 * @param whetherInvested the whetherInvested to set
	 */
	public void setWhetherInvested(Integer whetherInvested) {
	...
	public String getIsBeforeRepay() {
		return isBeforeRepay;
	}

	public void setIsBeforeRepay(String isBeforeRepay) {
	...
	public String toString() {
		return "Loan [id=" + id + ", name=" + name + ", borrowMoneyUser="
				...
				+ ", yaCarAndGPS=" + yaCarAndGPS + ", remark=" + remark + " sortNum=" + sortNum + "]";
	}
}
