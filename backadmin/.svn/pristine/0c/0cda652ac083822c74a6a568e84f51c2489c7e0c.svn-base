...
public class AESUtil {
	...
	public static void main(String[] args) throws Exception {
        ...
        System.out.println("解密后：" +  decode("AB61C34813563AA890C5D1D180F5A2653AF60A1FC7A9DD62E8F311D5EB53AE11"));
	}
     ...
     * @return
     */
    public static String encode(String temp,String pass){
    	byte[] tempByte = AESUtil.encrypt(temp,pass);  //加密
		temp = AESUtil.parseByte2HexStr(tempByte);   //将二进制转换成16进制
		return temp;
    }
     ...
     * @return
     */
    public static String decode(String temp,String pass){
    	byte[] tempByte = AESUtil.parseHexStr2Byte(temp);  //将16进制转换为二进制
		tempByte = AESUtil.decrypt(tempByte,pass);  //解密
		try {
			temp = new String(tempByte,"UTF-8");
		}catch(UnsupportedEncodingException e) {
			e.printStackTrace();
