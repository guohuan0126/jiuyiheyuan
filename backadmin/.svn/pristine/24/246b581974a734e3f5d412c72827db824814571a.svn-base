...
public interface InvestDao extends BaseDao<Invest> {
	 ...
	 * @return
	 */
	PageInfo<InvestRedpacket> pageLiteInvestredpacket(int pageNo, int pageSize, InvestRedpacket investRedpacket);
	 ...
	 * @return
	 */
	double getInvestSeccessFeeByLoanId(String loanId);
	/**
	 * 根据条件查询个人的投资信息
	 * @param map
	 * @return
