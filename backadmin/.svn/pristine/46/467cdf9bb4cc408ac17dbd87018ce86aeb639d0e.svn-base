          ...
          <div class="panel panel-default">
              ...
              <div class="panel-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-3">
                  	<input type="hidden"  name="id" id="id" value="${paymentBankInfo.id}" width="10px" class="form-control" />
                    <input type="text"  name="name" id="name" value="${paymentBankInfo.name}" width="10px" class="form-control" />
                  </div>
...
<script>
	...
	function sub(){
		...
		$.ajax({
	        type: "POST",
	        url:'/payMentChannel/editPayMentBankInfo',
	...
	function sufile(){
		...
		$.ajax({
			...
			success:function(data) {
				...
				$('#errorlogo').attr("style", "display:none;");
			},
			error:function(e){ 
				alert(e);
			}
