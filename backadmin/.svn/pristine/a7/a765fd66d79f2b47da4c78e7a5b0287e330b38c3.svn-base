					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input type="text" name="borrower" id="borrower"
										...
										onblur="verifyParam('borrower')" value="${base:decrypt(mobilenum)}"/>	
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input type="text" name="totalMoney" id="totalMoney"
										width="10px" class="form-control" 
										onblur="verifyParam('totalMoney')" value="${ruralfinanceData.money}"/>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<select name="repayType" id="repayType" onchange="sb()" >
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input type="text" name="rate" id="rate" width="10px"
										class="form-control" onblur="verifyParam('rate')" value="${ruralfinanceData.rate}"/>
								</div>
							</div>
                            <div class="form-group">
								...
								<div class="col-sm-3">
									<input type="text" name="remark" id="remark" width="10px"
										class="form-control" value="${ruralfinanceData.remark}"/>
								</div>
							</div>
			...
			if(num == 0){
				if(confirm('确认操作借款项目?')){
					...
					$.ajax({						
						type : "POST",
						dataType : 'text',
						url : "${request.contextPath()}/agricultural/UpdateLoanProject",
