				...
				<form id="form" method="post" class="form-horizontal">
					<div class="panel panel-default">
						<div class="panel-heading">
							...
							<h5 class="panel-title">添加平台账户充值记录</h5>
						</div>
						<div class="panel-body">
							...
							<div class="form-group">
								<label class="col-sm-3 control-label">充值手续费</label>
								<div class="col-sm-3">
							...
							<!-- <div class="form-group">
								...
								<div class="col-sm-3">
									<select class="select2" name="rechargeType" id="rechargeType"
										...
										<option value="gateway">网关充值</option>
										<option value="quick">快速充值</option>
									</select>
								</div>
							</div> -->
							<div class="form-group">
				...
				$.ajax({
					...
					beforeSend:function(){
					 ...
					 success:function(data) {
						...
						if (data == 'success') {
							alert("添加平台账户充值记录成功");
							window.location.href="/account/platformAccountList";
						} else {
							alert("添加平台账户充值记录失败，"+data);
						}
					}
