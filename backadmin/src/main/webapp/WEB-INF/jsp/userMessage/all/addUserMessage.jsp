	...
	<section>
				...
				<form id="form" method="post" class="form-horizontal">
					<div class="panel panel-default">
						<div class="panel-heading">
							...
							<h4 class="panel-title">创建短信模板</h4>
						</div>
						<div class="panel-body">
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input type="text" name="id" id="id"  width="10px"
										class="form-control" placeholder="短信号不能为空且不可重" onkeyup="value=value.replace(/[^\w\.\/]/ig,'')" />
									<div id="errorId" style="display: none;">短信号不能为空</div>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-3" style="width:40%">								
									<textarea rows="3" name="description"  id="description" class="form-control" placeholder="备注"></textarea>	
								</div>																									
							</div>
							<div class="form-group">
								...
								<div class="col-sm-3" style="width:74%">
									<textarea name="template" id="template" style="width: 100%;height: 300px;" 
									></textarea>
		...
		<script type="text/javascript">
			function sub(){
				...
				$.ajax({
					type : 'POST',
					url : '${ctx}/createOrEditUserMessage/create',						
					data:$('#form').serialize(),
					success:function(data) {
						if(data == 1){
							alert("添加成功");
							location = "${cxt}/userMessageList/show";						 					
						}else if(data == -1){
							$('#errorId').text("编号重复");
							$('#errorId').attr("style", "display:block;font-size:14px;color:red");
							return ;
