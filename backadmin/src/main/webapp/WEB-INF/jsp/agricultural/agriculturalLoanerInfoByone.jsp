		...
		<div class="mainpanel">
			...
			<div class="contentpanel">
				...
				<div class="panel panel-default">					
					<form action="/agricultural/queryUserInfo" id="from1" method="post" >
					<div class="form-group" style="padding-top:20px;">
								&nbsp;&nbsp;&nbsp;<span style="font-size: 18px;">借款人信息：</span> 
									 <input type="text" id="name" name="name"  class="form-control" value="${id}" style="width:212px;display:inline-block;" placeholder="姓名/手机号/身份证号"></input>
						...
						<table class="table table-primary table-striped table-hover ">
							<thead>
								...
								<tr>
									...
									<td>
									<c:if test="${!empty loanerinfo.id}">
										<c:if test="${loanerinfo.status !='check'}">
