	...
	<section>
		...
		<div class="mainpanel">
			...
			<div class="pageheader">
				<h2>
					<i class="fa fa-pencil"></i>创建农贷借款项目
				</h2>
			</div>
				...
				<form id="form1" method="post" class="form-horizontal">
					<div class="panel panel-default">
						<div class="panel-heading">
							...
							<h4 class="panel-title">创建农贷借款项目--基本信息</h4>
						</div>
			...
			if(num == 0){
				if(confirm('确认操作借款项目?')){
					...
					$.ajax({						
						type : "POST",
						dataType : 'text',
						url : "${request.contextPath()}/agricultural/CreateLoanProject",
						...
						success : function(data) {
							...
							xval.remove();						
							if (data == 'success') {
								//location = "/agricultural/ruralfinance_data";
								alert("添加成功");
								location.reload();
							} else{
				               location = "/";	
