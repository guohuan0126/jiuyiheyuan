	...
	<section>
						...
						<div class="panel-body">
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input type="text" name="id" id="id"  width="10px"
										class="form-control" placeholder="编号不能为空" value="${categoryTerm.id}" readonly/>
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input type="text" name="name" id="name"  width="10px"
										class="form-control" value="${categoryTerm.name}"/>	
							...
							<div class="form-group">
								...
								<div class="col-sm-3" style="width:40%">								
									<textarea rows="3" name="description"  id="description" class="form-control">${categoryTerm.description}</textarea>	
								</div>																									
							</div>
							<div class="form-group">
								<label class="col-sm-3 control-label">顺序</label>
								<div class="col-sm-3" style="width:40%">								
									<input type="number" name="seqNum" id="seqNum"  width="10px"
										value="${categoryTerm.seqNum}" min="0"/>	
								</div>																									
							</div>
						...
						<div class="panel-footer">
							<div class="row">
								<div class="col-sm-9 col-sm-offset-3">
									...
									<button type="button" onclick="return ret();"  class="btn btn-default">重置</button>
								</div>
							</div>
						</div>
					</div>
		...
		<script type="text/javascript">
			function sub(){
				...
				$.ajax({
					type : 'POST',
					url : '${ctx}/article/categoryTerm/edit',						
					data:$('#form').serialize(),
