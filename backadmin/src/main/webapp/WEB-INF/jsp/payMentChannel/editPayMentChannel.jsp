          ...
          <div class="panel panel-default">
              ...
              <div class="panel-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-3">
                    <input type="text"  name="payMentChannelName" id="payMentChannelName" value="${payMentChannel.name}" width="10px" class="form-control" />
                  	<input type="hidden"  name="id" id="id" value="${payMentChannel.id}" width="10px" class="form-control" />
	           ...
	           <div class="form-group">
	            ...
	            <div class="form-group">
                  ...
                  <div class="col-sm-3">
                    <input type="text" id="sort" name="sort" value="${payMentChannel.sort}"  style="width:70px;"/>
                </div> 
...
<script>
	$('#PCusable').val('${payMentChannel.usable}'); 
	$('#Mobusable').val('${payMentChannel.mobileUsable}'); 
	...
	function sub(){
		...
		$.ajax({
	        type: "POST",
	        url:'/payMentChannel/editPayMentChannel',
