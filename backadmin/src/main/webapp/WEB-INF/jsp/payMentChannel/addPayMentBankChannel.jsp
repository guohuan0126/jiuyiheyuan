          ...
          <div class="panel panel-default">
              ...
              <div class="panel-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-3">
                    <input type="text" name="oneMoney" id="oneMoney"  placeholder="单笔限额"  class="form-control"/>
                  </div>   
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-3">
                    <input type="text" name="dayMoney" id="dayMoney"  placeholder="单日限额"  class="form-control"/>
                  </div>   
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-3">
                    <input type="text" name="monthMoney" id="monthMoney"  placeholder="单月限额"  class="form-control"/>
                  </div>   
...
<script>
	...
	function sub(){
		$('#erroroneMoney').attr("stype", "display:none;");
		$('#errordayMoney').attr("stype", "display:none;");
		$('#errormonthMoney').attr("stype", "display:none;");
		...
		$.ajax({
	        type: "POST",
	        url:'/payMentChannel/addPayMentBankChannel',
