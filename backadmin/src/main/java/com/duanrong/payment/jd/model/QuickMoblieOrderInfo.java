 ...
 */
public class QuickMoblieOrderInfo implements Serializable {
	...
	public String toString() {
		...
		xml.append("<form method=\"post\" action=\"https://m.jdpay.com/wepay/web/pay\">");
		...
		xml.append("<input type=\"hidden\" name=\"failCallbackUrl\" value=\""+this.failCallbackUrl+"\"/>");
