...
public class PermissionServiceImpl implements PermissionService {
	...
	@Override
	public List<Permission> readPermisstionByUserId(String userId) {
		return permissionDao.getPermissionByUserId(userId);
	}

	@Override
	public PageInfo<Permission> readPageLite(int pageNo, int pageSize,
	...
	public void insertPermission(Permission permission) throws Exception {
		if (null == readPermissionById(permission.getId())) {
	...
	@Override
	public List<Permission> readPermisstionByRoleId(String roleId) {
	...
	/**
	 * 把数据库里面有的而页面没有的用户权限删除
	 */
	@Override
	public int deleteUserRoleID(Map<String, String> map){
		return permissionDao.deleteUserRoleID(map);
	}
	@Override
	...
	@Override
	public List<Permission> readPermissionByMenuId(int newMenuId) {
	...
	@Override
	public List<String> readHasActivePermission(String userId) {				
		return permissionDao.getActiveByUserIdAndId(userId);
	}

	@Override
	public List<String> readIpList() {
	...
	@Override
	public String readSuper(String name) {
		return permissionDao.getSuper(name);
	}

	@Override
	public PageInfo<Black> readBlackPageInfo(int pageNo, int pageSize,Map<String, Object> types) {
	...
	@Override
	public List<Black> readBlackByType(String type) {
