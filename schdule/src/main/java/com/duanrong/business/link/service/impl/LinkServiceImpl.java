...
public class LinkServiceImpl implements LinkService {
	...
	@Override
	public PageInfo<LinkType> getLikeTypePageLite(int pageNo, int pageSize, LinkType linkType) {
	...
	@Override
	public PageInfo<Link> pageLite(int pageNo, int pageSize, Link link) {		
		return linkDao.pageLite(pageNo, pageSize, link);
	}

	@Override
	public String insertLink(Link link) {
		if(getLink(link.getId()) == null){
			linkDao.insert(link);
			return "ok";
		}
		return "notNull";
