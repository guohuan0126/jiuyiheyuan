...
//		public static final String MOBILE_QUICK = p.getProperty("MOBILE_QUICK");//移动快捷
	}
	...
	public static final class FuiouConfig{
		 ...
		 * 请求地址
		 */
		 public static final String FUIOU_QUERY_MOBILE_URL=p.getProperty("FUIOU_QUERY_MOBILE_URL");
