...
public class NodeServiceImpl implements NodeService {
	...
	@Override
	public PageInfo<CategoryTerm> getPageInfoForCategoryTerm(int pageNo,
	...
	@Override
	public PageInfo<Node> getPageInfoForNode(int pageNo, int pageSize, Node node) {

		return nodeDao.pageLite(pageNo, pageSize, node);
	}
	...
	public Node get(String id) {		
		...
		List<String> termNames = getTermNameByNodeId(id);
	...
	public String update(Node node) {		
		...
		if(n != null){
			...
			nodeDao.update(node);
			nodeDao.deleteNodeTerm(node.getId());
