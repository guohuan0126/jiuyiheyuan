...
//		public static final String WITHDRAW_CASH = "http://p2p.ips.net.cn/CreditWeb/dwTrade.aspx";
	...
	public static final class ResponseWebUrl {
		 ...
		 * 地址前缀(测试)
		 */
//		public static final String PRE_RESPONSE_URL = "http://localhost:8080/minzzj/trusteeship_return_web/";
	...
	public static final class ResponseS2SUrl {
		 ...
		 * 地址前缀(测试)
		 */
//		public static final String PRE_RESPONSE_URL = "http://localhost:8080/minzzj/trusteeship_return_s2s/";
	}
