...
public class WithdrawCashDaoImpl extends BaseDaoImpl<WithdrawCash> implements
	...
	@Override
	public List<WithdrawCash> getWithdrawCashByDateAndStatus(
			Map<String, Object> map) {
		return this.getSqlSession().selectList(this.getMapperNameSpace() + ".getWithdrawCashByDateAndStatus", map);
	}
}
